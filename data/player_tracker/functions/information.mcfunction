...
tellraw @s [" "]
tellraw @s [{"text":"You can view the main menu by typing\n"},{"text":"/trigger pt.menu","color":"aqua","clickEvent":{"action":"suggest_command","value":"/trigger pt.menu"},"hoverEvent":{"action":"show_text","contents":"Click to enter command"}}]
tellraw @s [" "]
tellraw @s [{"text":"You can select a which player you would like to track by looking down while holding the compass and right clicking,\nor by typing\n"},{"text":"/trigger pt.player_list","color":"aqua","clickEvent":{"action":"suggest_command","value":"/trigger pt.player_list"},"hoverEvent":{"action":"show_text","contents":"Click to enter command"}}]
tellraw @s [" "]
