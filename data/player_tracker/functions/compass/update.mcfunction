...
execute if entity @s[nbt={Dimension:"minecraft:overworld"}] unless entity @a[tag=tracking,nbt={Dimension:"minecraft:overworld"}] run data modify storage hnr:compass Items[].tag.LodestoneDimension set value "minecraft:the_end"
execute if entity @s[nbt={Dimension:"minecraft:the_nether"}] unless entity @a[tag=tracking,nbt={Dimension:"minecraft:the_nether"}] run data modify storage hnr:compass Items[].tag.LodestoneDimension set value "minecraft:the_end"
execute if entity @s[nbt={Dimension:"minecraft:the_end"}] unless entity @a[tag=tracking,nbt={Dimension:"minecraft:the_end"}] run data modify storage hnr:compass Items[].tag.LodestoneDimension set value "minecraft:the_nether"
