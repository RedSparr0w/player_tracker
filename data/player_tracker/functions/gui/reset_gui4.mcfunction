...
#> Next/Previous Page
item replace entity @s container.18 with minecraft:arrow{display:{Name:"[{\"text\":\"Previous Page (3)\",\"italic\":false}]"},gui_item:1b}

#> Fill in player heads
data modify entity @s Items[0] set from storage pt:player_heads Items[75]
data modify entity @s Items[1] set from storage pt:player_heads Items[76]
data modify entity @s Items[2] set from storage pt:player_heads Items[77]
data modify entity @s Items[3] set from storage pt:player_heads Items[78]
data modify entity @s Items[4] set from storage pt:player_heads Items[79]
data modify entity @s Items[5] set from storage pt:player_heads Items[80]
data modify entity @s Items[6] set from storage pt:player_heads Items[81]
data modify entity @s Items[7] set from storage pt:player_heads Items[82]
data modify entity @s Items[8] set from storage pt:player_heads Items[83]
data modify entity @s Items[9] set from storage pt:player_heads Items[84]
data modify entity @s Items[10] set from storage pt:player_heads Items[85]
data modify entity @s Items[11] set from storage pt:player_heads Items[86]
data modify entity @s Items[12] set from storage pt:player_heads Items[87]
data modify entity @s Items[13] set from storage pt:player_heads Items[88]
data modify entity @s Items[14] set from storage pt:player_heads Items[89]
data modify entity @s Items[15] set from storage pt:player_heads Items[90]
data modify entity @s Items[16] set from storage pt:player_heads Items[91]
data modify entity @s Items[17] set from storage pt:player_heads Items[92]
data modify entity @s Items[19] set from storage pt:player_heads Items[93]
data modify entity @s Items[20] set from storage pt:player_heads Items[94]
data modify entity @s Items[21] set from storage pt:player_heads Items[95]
data modify entity @s Items[22] set from storage pt:player_heads Items[96]
data modify entity @s Items[23] set from storage pt:player_heads Items[97]
data modify entity @s Items[24] set from storage pt:player_heads Items[98]
data modify entity @s Items[25] set from storage pt:player_heads Items[99]
data modify entity @s Items[26] set from storage pt:player_heads Items[100]
