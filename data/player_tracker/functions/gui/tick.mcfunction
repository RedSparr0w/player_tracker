...
execute as @e[type=minecraft:chest_minecart,tag=gui_container] at @s run execute unless entity @e[distance=..3,tag=has_gui_item] run function player_tracker:gui/removecart
