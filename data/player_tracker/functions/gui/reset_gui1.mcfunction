item replace entity @s container.0 with minecraft:player_head{display:{Name:"{\"text\":\"Nearest Player\"}",Lore:["[{\"text\":\"Click to track nearest player\",\"italic\":false}]"]},SkullOwner:{Id:[I;-70110839,788745499,-1322095161,-151126083],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGEyZmRlMzRkMzRjODU4OGU1OGJmZDc5MGNlMTgwMjVmNzg0MzM5OWRlZTJhYjRjZWRjMmMwYjQ2M2ZkMWUifX19"}]}},gui_item:1b}
...
item replace entity @s container.26 with minecraft:arrow{display:{Name:"[{\"text\":\"Next Page (2)\",\"italic\":false}]"},gui_item:1b}

data modify entity @s Items[1] set from storage pt:player_heads Items[0]
data modify entity @s Items[2] set from storage pt:player_heads Items[1]
data modify entity @s Items[3] set from storage pt:player_heads Items[2]
data modify entity @s Items[4] set from storage pt:player_heads Items[3]
data modify entity @s Items[5] set from storage pt:player_heads Items[4]
data modify entity @s Items[6] set from storage pt:player_heads Items[5]
data modify entity @s Items[7] set from storage pt:player_heads Items[6]
data modify entity @s Items[8] set from storage pt:player_heads Items[7]
data modify entity @s Items[9] set from storage pt:player_heads Items[8]
data modify entity @s Items[10] set from storage pt:player_heads Items[9]
data modify entity @s Items[11] set from storage pt:player_heads Items[10]
data modify entity @s Items[12] set from storage pt:player_heads Items[11]
data modify entity @s Items[13] set from storage pt:player_heads Items[12]
data modify entity @s Items[14] set from storage pt:player_heads Items[13]
data modify entity @s Items[15] set from storage pt:player_heads Items[14]
data modify entity @s Items[16] set from storage pt:player_heads Items[15]
data modify entity @s Items[17] set from storage pt:player_heads Items[16]
data modify entity @s Items[18] set from storage pt:player_heads Items[17]
data modify entity @s Items[19] set from storage pt:player_heads Items[18]
data modify entity @s Items[20] set from storage pt:player_heads Items[19]
data modify entity @s Items[21] set from storage pt:player_heads Items[20]
data modify entity @s Items[22] set from storage pt:player_heads Items[21]
data modify entity @s Items[23] set from storage pt:player_heads Items[22]
data modify entity @s Items[24] set from storage pt:player_heads Items[23]
data modify entity @s Items[25] set from storage pt:player_heads Items[24]
