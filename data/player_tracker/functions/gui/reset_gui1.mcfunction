replaceitem entity @s container.0 minecraft:player_head{display:{Name:"{\"text\":\"Nearest Player\"}",Lore:["[{\"text\":\"Click to track nearest player\",\"italic\":false}]"]},SkullOwner:{Id:[I;-70110839,788745499,-1322095161,-151126083],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGEyZmRlMzRkMzRjODU4OGU1OGJmZDc5MGNlMTgwMjVmNzg0MzM5OWRlZTJhYjRjZWRjMmMwYjQ2M2ZkMWUifX19"}]}},gui_item:1b}
...
replaceitem entity @s container.26 minecraft:arrow{display:{Name:"[{\"text\":\"Next Page (2)\",\"italic\":false}]"},gui_item:1b}
